...
# X, y = strat_train_set['title'], strat_train_set['label']
...
# stratified2 = StratifiedShuffleSplit(test_size=0.25)
# for train_index, test_index in stratified2.split(X, y):
#     msg_train, msg_validation = X.iloc[train_index], X.iloc[test_index]
#     label_train, label_validation = y.iloc[train_index], y.iloc[test_index]
